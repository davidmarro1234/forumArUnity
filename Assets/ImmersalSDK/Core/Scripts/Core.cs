...
namespace Immersal
{
    ...
    public static class Core
    {
        ...
        public static int GetPointCloud(int mapId, Vector3[] points)
        {
            ...
            int n = Native.icvPointsGet(mapId, vector3ArrayHandle.AddrOfPinnedObject(), points.Length);
        ...
        public static int FreeMap(int mapId) => Native.icvFreeMap(mapId);
        ...
        public static int LocalizeImage(out Vector3 pos, out Quaternion rot, int width, int height, ref Vector4 intrinsics, byte[] pixels) => Native.icvLocalize(out pos, out rot, width, height, ref intrinsics, pixels);
...
#endif
        [DllImport(Assembly)]
        public static extern int icvPointsGet(int mapId, System.IntPtr array, int maxCount);

        [DllImport(Assembly)]
        public static extern int icvLoadMap(byte[] buffer);

        [DllImport(Assembly)]
        public static extern int icvFreeMap(int mapId);

        [DllImport(Assembly)]
        public static extern icvCaptureInfo icvCaptureImage(System.IntPtr capture, int captureSizeMax, System.IntPtr pixels, int width, int height, int channels);

        [DllImport(Assembly)]
        public static extern int icvLocalize(out Vector3 pos, out Quaternion rot, int width, int height, ref Vector4 intrinsics, byte[] pixels);

        [DllImport(Assembly)]
        public static extern int icvMapToEcefGet(System.IntPtr mapToEcef, int handle);

        [DllImport(Assembly)]
        public static extern int icvPosMapToEcef(System.IntPtr ecef, ref Vector3 map, System.IntPtr mapToEcef);

        [DllImport(Assembly)]
        public static extern int icvPosEcefToWgs84(System.IntPtr wgs84, System.IntPtr ecef);

        [DllImport(Assembly)]
        public static extern int icvPosWgs84ToEcef(System.IntPtr ecef, System.IntPtr wgs84);

        [DllImport(Assembly)]
        public static extern int icvPosEcefToMap(out Vector3 map, System.IntPtr ecef, System.IntPtr mapToEcef);

        [DllImport(Assembly)]
        public static extern int icvRotMapToEcef(out Quaternion ecef, ref Quaternion map, System.IntPtr mapToEcef);

        [DllImport(Assembly)]
        public static extern int icvRotEcefToMap(out Quaternion map, ref Quaternion ecef, System.IntPtr mapToEcef);
